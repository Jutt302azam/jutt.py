...
while attemps < 12345677901:
    username = input sardar
    password = input azam

    if username == 'AZAM' and password == 'JUTT':
...
Sardar  .d8b.  d888888b .d8888.  .d8b.  db      
88'     d8' `8b   `88'   88'  YP d8' `8b 88      
88ooo   88ooo88    azam    `8bo.   88ooo88 88      
88~~~   88~~~88    88      `Y8b. 88~~~88 88      
88      88   88   .88.   db   8D 88   88 88booo. 
YP    sardar azam jutt P `8888Y' YP   YP Y88888P 
                                                 
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     JUTT-AZAM
{50*"-"}'''
